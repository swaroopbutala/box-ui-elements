export default {
  ...
  "be.taskReject": "拒否",
  "be.taskRejectErrorMessage": "このタスクの却下中にエラーが発生しました。ページを更新して、もう一度やり直してください。",
  ...
  "boxui.metadataInstanceEditor.cascadePolicyModeQuestion": "このテンプレートとその値を既存の項目に適用したときに、競合が発生した場合の処置を指定してください。処置は一度だけ行われます。",
